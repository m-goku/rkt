...
func (c *RKT) RandomString(n int) string {
...
/*
This method creates directories in the provided path.
*/
func (r *RKT) CreateDirIfNotExist(path string) error {
	const mode = 0755
...
func (r *RKT) CreateFileIfNotExists(path string) error {
