...
func doNew(appName string) {
	...
	auth, err := gitssh.NewPublicKeysFromFile("git", os.Getenv("USERPROFILE")+"\\.ssh\\id_ed25519", "")
	if err != nil {
	...
	_, err = git.PlainClone("./"+appName, false, &git.CloneOptions{
		URL:      "git@github.com:m-goku/rkt-app.git",
		Auth:     auth,
		Progress: os.Stdout,
		Depth:    1,
	})
	...
	env = strings.ReplaceAll(env, "${KEY}", r.RandomString(32))
