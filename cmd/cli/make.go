...
func doMake(arg2, arg3 string) error {
	...
	case "migration":
		...
		upFile := r.RootPath + "/migrations/" + fileName + "." + dbType + ".up.sql"
		downFile := r.RootPath + "/migrations/" + fileName + "." + dbType + ".down.sql"
	...
	case "handler":
		...
		fileName := r.RootPath + "/handlers/" + strings.ToLower(arg3) + ".go"
	...
	case "model":
		...
		fileName := r.RootPath + "/data/" + strings.ToLower(modelName) + ".go"
		if fileExists(fileName) {
			exitGracefully(errors.New(fileName + " already exists!"))
		}
	...
	case "mail":
		...
		htmlMail := r.RootPath + "/mail/" + strings.ToLower(arg3) + ".html.tmpl"
		plainMail := r.RootPath + "/mail/" + strings.ToLower(arg3) + ".plain.tmpl"
